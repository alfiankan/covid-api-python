...
class CovidTestApiHandler():
    ...
    def route(self):
        @self.http.route('/test', methods=['GET'])
        def _getGeneralInformationCovidTest():
            return self.getGeneralInformation()

        @self.http.route('/test/yearly', methods=['GET'])
        def _getYearlyDataCovidTest():
            return self.getYearlyData()

        @self.http.route('/test/yearly/<year>')
        def _getDataByYearCovidTest(year):
            return self.getDataByYear(year)

        @self.http.route('/test/monthly', methods=['GET'])
        def _getMonthlyDataCovidTest():
            return self.getMonthlyData()

        @self.http.route('/test/monthly/<year>', methods=['GET'])
        def _getMonthlyDataByYearCovidTest(year):
            return self.getMonthlyDataByYear(year)

        @self.http.route('/test/monthly/<year>/<month>', methods=['GET'])
        def _getMonthlyDataByYearMonthCovidTest(year, month):
            return self.getMonthlyDataByYearMonth(year, month)

        @self.http.route('/test/daily', methods=['GET'])
        def _getDailyDataCovidTest():
            return self.getDailyData()

        @self.http.route('/test/daily/<year>', methods=['GET'])
        def _getDailyDataByYearCovidTest(year):
            return self.getDailyDataByYear(year)

        @self.http.route('/test/daily/<year>/<month>', methods=['GET'])
        def _getDailyDataInYearMonthCovidTest(year, month):
            return self.getDailyDataInYearMonth(year, month)

        @self.http.route('/test/daily/<year>/<month>/<date>', methods=['GET'])
        def _getDailyDataByDateCovidTest(year, month, date):
